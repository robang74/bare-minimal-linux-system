...
- origin: [github.com/byte4RR4Y/aarch64-kernel-for-qemu](https://github.com/byte4RR4Y/aarch64-kernel-for-qemu) by [https://github.com/byte4RR4Y](Daniel Wieczorek)
...
```sh
apt update -y && apt install -y git bc bison flex libssl-dev make \
    libc6-dev libncurses5-dev crossbuild-essential-arm64
```
